...
const Invoices = ({ isOpen }) => {
		...
		const fetchinvoiceData = async () => {
			try {
				const response = await axios.get(
					"https://theme-park-backend.ambitioussea-02dd25ab.eastus.azurecontainerapps.io/api/v1/invoices/"
				);
	...
	const columns = [
		...
		{ field: "due_date", headerName: "Payment Due Date", flex: 0.3 },
	...
	return (
		...
		>
			...
			>
				<Header
					title="Invoices💻"
					subtitle="Track & view vendor invoices"
				/>
				<Box display="flex" alignItems="center">
					<PrintButton
						apiUrl="https://theme-park-backend.ambitioussea-02dd25ab.eastus.azurecontainerapps.io/api/v1/invoices/"
						columns={columns}
					/>
					<DownloadButton
						apiUrl="https://theme-park-backend.ambitioussea-02dd25ab.eastus.azurecontainerapps.io/api/v1/invoices/"
