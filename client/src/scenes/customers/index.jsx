		...
		const fetchCustomers = async () => {
			try {
				const response = await axios.get(
					"https://theme-park-backend.ambitioussea-02dd25ab.eastus.azurecontainerapps.io/api/v1/customers/"
				);
	...
	return (
		...
		>
			...
			>
				<Header
					title="Customers✅"
					subtitle="View registered member information(?) *@team, wb no registered customers who just buy ticket*"
				/>
